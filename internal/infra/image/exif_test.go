...
func TestReadMeta(t *testing.T) {
	f, err := os.Open("testdata/IMG_5612.jpg")
	defer func() {
		require.NoError(t, f.Close())
	}()
	require.NoError(t, err)
...
func TestReadMeta_DisplayP3(t *testing.T) {
	f, err := os.Open("testdata/faces.jpg")
	defer func() {
		require.NoError(t, f.Close())
	}()
	require.NoError(t, err)
...
func TestReadMeta_360(t *testing.T) {
	f, err := os.Open("testdata/360.jpg")
	require.NoError(t, err)
	defer func() {
		require.NoError(t, f.Close())
	}()
...
func TestReadExif2(t *testing.T) {
	f, err := os.Open("testdata/faces.jpg")
	require.NoError(t, err)
	defer func() {
		require.NoError(t, f.Close())
