...
type AlbumSettings struct {
	...
	Redirect        string     `json:"redirect,omitempty" noTitle:"true" inlineTitle:"Relative or absolute URL to redirect to with HTTP 301 status."`
	HideMap         bool       `json:"hide_map,omitempty" noTitle:"true" inlineTitle:"Hide map on album page."`
	HideDownload    form.Bool3 `json:"hide_download,omitzero" noTitle:"true" inlineTitle:"Hide download on album page."`
	...
	SkipSprites     bool       `json:"skip_sprites,omitzero" noTitle:"true" inlineTitle:"Skip thumb sprites on album page."`
